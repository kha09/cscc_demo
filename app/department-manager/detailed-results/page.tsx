...
export default function DepartmentManagerDetailedResults() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Remove the acknowledged review from the state
      setReviews(prev => {
  ...
  return (
    <div className="p-6" dir="rtl">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl font-bold mb-6">مراجعات مدير الأمن</h1>
        ...
        {Object.keys(reviews).length === 0 ? (
          <Card className="p-6 text-center text-gray-500">
            لا توجد مراجعات جديدة تحتاج إلى اهتمامك
          </Card>
        ) : (
              ...
              <div className="space-y-4">
                {componentReviews.map((review) => (
                  <div key={review.id} className="border-b pb-4 last:border-0 last:pb-0">
                    ...
                    {review.note && (
                      <p className="text-gray-600 mb-2">{review.note}</p>
                    )}
        ...
        <DialogContent className="sm:max-w-[425px]" dir="rtl">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value={ReviewStatus.FINISHED}>اعتماد</SelectItem>
                  <SelectItem value={ReviewStatus.REVIEW_REQUESTED}>طلب مراجعة</SelectItem>
                </SelectContent>
              </Select>
            </div>
            {formData.action === ReviewStatus.REVIEW_REQUESTED && (
              <div className="grid gap-2">
                <Textarea
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={isSaving || !formData.action || (formData.action === ReviewStatus.REVIEW_REQUESTED && !formData.note)}
            >
              {isSaving ? (
                <>
