...
export default function ProcessTimeline() {
    var timelineItems = [
        ...
        },
        {
            ...
            title: "تجهيز الأدلة",
            description: "تقوم الجهة بتجهيز الأدلة وذلك لأعمال التدقيق من قبل الهيئة بحيث تكون معلومات الدليل واضحة، ومكتملة، ومترابطة، ومنظمة، وتتعلق بالسنة والنظام ومن الناحية الأساسي والفرعي",
            color: "bg-blue-900",
            position: "right",
        },
        {
    ...
    return (<section className="" dir="rtl">
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            <div className="space-y-20">
              ...
              {timelineItems.map(function (item, index) { return (<div key={index} className="relative z-10">
                  {/* Timeline dot */}
                  <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <div className={"flex items-center justify-center w-12 h-12 rounded-full ".concat(item.color)}>
                      {item.icon}
                    </div>
                  </div>

                  {/* Content */}
                  <div className={"flex ".concat(item.position === "right" ? "justify-start" : "justify-end")}>
                    <div className={"w-5/12 ".concat(item.position === "right" ? "pr-8" : "pl-8")}>
                      <h3 className={"text-xl font-bold mb-2 text-center ".concat(item.position === "right" ? "text-blue-900" : "text-teal-500")}>
                        {item.title}
                      </h3>
