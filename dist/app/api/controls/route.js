...
export function GET() {
    return __awaiter(this, void 0, void 0, function () {
        var controls, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, prisma.control.findMany({
                            select: {
                                id: true,
                ...
                case 1:
                    controls = _a.sent();
                    return [2 /*return*/, NextResponse.json(controls)];
                case 2:
                    error_1 = _a.sent();
                    console.error("Failed to fetch controls:", error_1);
                    return [2 /*return*/, NextResponse.json({ message: "Failed to fetch controls" }, { status: 500 })];
