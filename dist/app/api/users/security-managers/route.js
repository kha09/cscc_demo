    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    securityManagers = _a.sent();
                    return [2 /*return*/, NextResponse.json(securityManagers)];
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching security managers:', error_1);
